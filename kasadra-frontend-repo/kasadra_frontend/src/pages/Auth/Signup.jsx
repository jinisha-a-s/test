            ...
            <div className='signup-right-body'>
              <div className='signup-right-body-box'>
                ...
                <form className='signup-form' onSubmit={handleSubmit}>
                  ...
                  <input type="tel" data-testid="input-email" placeholder='Enter Phone Number' className='signup-input-field' name='phone_no' onChange={handleChange} value={formData.phone_no} minLength="10" maxLength="10" required />
                  <input type="email" data-testid="input-phone" placeholder='Enter Email' className='signup-input-field' name='email' onChange={handleChange} value={formData.email} />
